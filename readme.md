...
ie:
```
 conda env config vars set PATH=/usr/local/cuda-12/bin:/home/joseph/anaconda3/envs/openPCDet/bin:/home/joseph/anaconda3/condabin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin:/snap/bin
```
...
Run: `python utils/gen_residual_images.py`
